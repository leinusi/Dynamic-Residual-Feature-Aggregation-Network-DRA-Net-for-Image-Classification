...
#python train2.py --data_dir data/eyes --batch_size 32 --lr 0.001 --meta_lr 0.0001 --pretrain_epochs 5 --attraction_epochs 3 --num_classes 6
...
def main(args):
    ...
    attention_attractor_net = DynamicResidualFeatureAggregationNetwork(num_classes=10, feature_dim=512).to(device)
